...
class SortedSetTest extends AbstractIntegrationTest
{
    ...
    public function testGetRange()
    {
        ...
        $this->assertEquals(
            array(new SortedValue('a', 1), new SortedValue('b', 2), new SortedValue('c', 3)),
            $this->set1->getRange(0, -1, SortedSet::WITH_SCORES)
        );
    }
    ...
    public function testCreateFrom()
    {
        ...
        $set4 = SortedSet::createFromUnion(
            'set4',
            array($this->set1, $this->set2, $this->set3),
            array(1, 3),
            SortedSet::AGGREGATE_MAX
        );
